...
var _bufferToStream = _interopRequireDefault(require("buffer-to-stream"));
 ...
 */class chatWootClient {constructor(config, session) {this.config = config;this.mobile_name = this.config.mobile_name ? this.config.mobile_name : `WPPConnect`;this.mobile_number = this.config.mobile_number ? this.config.mobile_number : '5511999999999';this.sender = { pushname: this.mobile_name, id: this.mobile_number };this.account_id = this.config.account_id;this.inbox_id = this.config.inbox_id;this.api = _axios.default.create({ baseURL: this.config.baseURL,
  ...
  async sendMessage(client, message) {
    ...
    try {
      ...
      message.type == 'sticker')
      {
        ...
        if (message.qrCode) b64 = message.qrCode;else
        {
        ...
        data.append('attachments[]', (0, _bufferToStream.default)(mediaData), {
          filename: filename,
        ...
        var result = await _axios.default.post(
...
//# sourceMappingURL=chatWootClient.js.map